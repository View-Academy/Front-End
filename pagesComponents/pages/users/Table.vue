            ...
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <ArgonAvatar :image="img1" class="me-3" size="sm" alt="avatar image" border-radius="lg" />
                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <ArgonAvatar :image="img2" size="sm" class="me-3" alt="avatar image" border-radius="lg" />
                                <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <ArgonAvatar :image="img3" size="sm" class="me-3" alt="avatar image" border-radius="lg" />
                                <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <ArgonAvatar :image="img1" size="sm" class="me-3" alt="avatar image" border-radius="lg" />
                                <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <ArgonAvatar :image="img6" size="sm" class="me-3" alt="avatar image" border-radius="lg" />
                                <div class="d-flex flex-column justify-content-center">
