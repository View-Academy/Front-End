      ...
      <div class="p-3 card-body">
         <div class="row">
            <div class="col-lg-5">
               ...
               <span v-for="({ label, isCompleted }, index) of labels" :key="index"
                  class="pb-0 mt-3 badge badge-dot d-block text-start">
                  <i :class="isCompleted ? 'bg-gradient-success' : 'bg-gradient-secondary'
                     "></i>
            ...
            <div class="my-auto col-lg-7">
               <div class="chart ms-auto">
                  <apexchart width="240" :options="chartOptions" :series="series"></apexchart>
               </div>
            </div>
         </div>
      </div>
