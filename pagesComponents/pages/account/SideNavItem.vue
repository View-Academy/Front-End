    ...
    <div>
        <div id="profile" class="card card-body mt-4">
            <div class="row justify-content-center align-items-center">
                <div class="col-sm-auto col-4">
                    <ArgonAvatar :image="img" alt="team-3" size="xl" shadow="sm" border-radius="lg" />
                </div>
                ...
                <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
                    ...
                    <ArgonSwitch id="switch-invisible" name="Switch to Invisible" checked />
                </div>
            </div>
        </div>
            ...
            <div class="card-body pt-0">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <ArgonInput id="email" type="email" placeholder="example@email.com" />
                    </div>
                    <div class="col-6">
                        <label class="form-label mt-2">Confirmation Email</label>
                        <ArgonInput id="confirm-email" type="email" placeholder="example@email.com" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
        ...
        <div id="password" class="card mt-4">
            ...
            <div class="card-body pt-0">
                ...
                <ArgonInput id="password" type="password" placeholder="Current Password" />
                <label class="form-label">New password</label>
                <ArgonInput id="new-password" type="password" placeholder="New Password" />
                <label class="form-label">Confirm new password</label>
                <ArgonInput id="confirm-password" type="password" placeholder="Confirm password" />
                ...
                <ArgonButton class="float-end mt-6 mb-0" color="dark" variant="gradient" size="sm">
                    Update password
                </ArgonButton>
            </div>
        </div>
        <div id="2fa" class="card mt-4">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <ArgonButton color="dark" variant="outline" size="sm" class="mb-0" type="button">
                        Add
                    </ArgonButton>
                </div>
            ...
            <div class="card-body pt-0">
                ...
                <div class="ps-5 pt-3 ms-3">
                    ...
                    <div class="d-sm-flex align-items-center bg-gray-100 border-radius-lg p-2 my-4">
                        ...
                        <ArgonInput id="verification-code" type="text" value="1172913" class="my-auto w-20 ms-sm-auto" />
                    </div>
                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
                        ...
                        <ArgonButton color="danger" variant="gradient" size="sm" class="my-sm-auto mt-2 mb-0" type="button"
                            name="button">
                            Delete
                        </ArgonButton>
                    </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ArgonSwitch id="notify-email" name="Email"
                                        class="form-check form-switch mb-0 d-flex align-items-center justify-content-center"
                                        checked />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-push" name="Push"
                                        class="form-check form-switch mb-0 d-flex align-items-center justify-content-center" />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-sms" name="Sms"
                                        class="form-check form-switch mb-0 d-flex align-items-center justify-content-center" />
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-1" colspan="4">
                                    <div class="my-auto">
                                        ...
                                        <span class="text-xs font-weight-normal">Notify when another user comments your
                                            item.</span>
                                    </div>
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-comment-email" name="Email"
                                        class="form-check form-switch mb-0 d-flex align-items-center justify-content-center"
                                        checked />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-comment-push" name="Push"
                                        class="form-check form-switch mb-0 d-flex align-items-center justify-content-center"
                                        checked />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-comment-sms" name="SMS"
                                        class="form-check form-switch mb-0 d-flex align-items-center justify-content-center" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ArgonSwitch id="notify-follow-email" name="Email"
                                        class="mb-0 d-flex align-items-center justify-content-center" checked />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-follow-push" name="Push"
                                        class="mb-0 d-flex align-items-center justify-content-center" checked />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-follow-sms" name="SMS"
                                        class="mb-0 d-flex align-items-center justify-content-center" checked />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ArgonSwitch id="notify-login-email" name="Email"
                                        class="mb-0 d-flex align-items-center justify-content-center" checked />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-login-push" name="Push"
                                        class="mb-0 d-flex align-items-center justify-content-center" checked />
                                </td>
                                <td>
                                    <ArgonSwitch id="notify-login-sms" name="SMS"
                                        class="mb-0 d-flex align-items-center justify-content-center" checked />
                                </td>
                            </tr>
                        </tbody>
        ...
        <div id="delete" class="card mt-4">
            ...
            <div class="card-body d-sm-flex pt-0">
                ...
                <ArgonButton color="secondary" variant="outline" class="mb-0 ms-auto" type="button" name="button">
                    Deactivate
                </ArgonButton>
                <ArgonButton color="danger" variant="gradient" class="mb-0 ms-2" type="button" name="button">
                    Delete Account
                </ArgonButton>
            </div>
        </div>
