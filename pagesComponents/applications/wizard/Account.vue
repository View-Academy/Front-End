    ...
    <div class="multisteps-form__content">
      <div class="mt-4 row">
        <div class="col-sm-3 ms-auto">
          ...
          <label class="px-6 py-5 border-2 btn btn-lg btn-outline-secondary" for="btncheck1">
            <svg class="text-dark" width="20px" height="20px" viewBox="0 0 40 40" version="1.1"
        ...
        <div class="col-sm-3">
          ...
          <label class="px-6 py-5 border-2 btn btn-lg btn-outline-secondary" for="btncheck2">
        ...
        <div class="col-sm-3 me-auto">
          ...
          <label class="px-6 py-5 border-2 btn btn-lg btn-outline-secondary" for="btncheck3">
            <svg class="text-dark" width="20px" height="20px" viewBox="0 0 40 40" version="1.1"
              xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <div class="mt-4 button-row d-flex">
        <button class="mb-0 btn bg-gradient-light js-btn-prev" type="button" title="Prev" @click="$parent.prevStep">
          Prev
        </button>
