        ...
        <div class="multisteps-form__content">
            <div class="mt-3 row">
                <div class="col-12 col-sm-4">
                    <div class="avatar avatar-xxl position-relative">
                        ...
                        <a href="#"
                            ...
                            <i class="top-0 fa fa-pen" data-bs-toggle="tooltip" data-bs-placement="top" title
                ...
                <div class="mt-4 col-12 col-sm-8 mt-sm-0 text-start">
                    ...
                    <input class="mb-3 multisteps-form__input form-control" type="text" placeholder="Eg. Michael" />
                    <label>Last Name</label>
                    <input class="mb-3 multisteps-form__input form-control" type="text" placeholder="Eg. Tomson" />
