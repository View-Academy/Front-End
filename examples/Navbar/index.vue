            ...
            <div class="sidenav-toggler sidenav-toggler-inner d-xl-block d-none">
                <a href="#" class="p-0 nav-link text-body" @click.prevent="toggleSidenav">
                    <div class="sidenav-toggler-inner">
                        <i class="sidenav-toggler-line" :class="navStore.navFixed && !navStore.darkMode
                            ? 'opacity-8 bg-dark'
                            : 'bg-white'
                            "></i>
                        <i class="sidenav-toggler-line" :class="navStore.navFixed && !navStore.darkMode
            ...
            <div id="navbar" class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4">
                ...
                <ul class="navbar-nav justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <NuxtLink to="/authentication/signin/basic" class="px-0 nav-link font-weight-bold" :class="navStore.navFixed && !navStore.darkMode
                            ? 'opacity-8 text-dark'
                            : 'text-white'
                            " target="_blank">
                    ...
                    <li class="px-3 nav-item d-flex align-items-center">
                        <a class="p-0 nav-link" @click="toggleShowConfig">
                            <i class="fas fa-cog pe-2 cursor-pointer fixed-plugin-button-nav" :class="navStore.darkMode || !navStore.navFixed
                                ? 'text-white'
                                : 'text-dark opacity-8'
                                "></i>
                        </a>
                    ...
                    <li class="nav-item dropdown d-flex align-items-center pe-2">
                        ...
                        <span class=" cursor-pointer" :class="navStore.darkMode || !navStore.navFixed
                            ? 'text-white'
                            : 'text-dark opacity-8'
