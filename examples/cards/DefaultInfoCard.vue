<template>
    <div class="card">
        <div class="p-3 mx-4 text-center card-header d-flex justify-content-center">
            <div :class="`icon icon-shape icon-lg shadow text-center border-radius-lg ${icon.background}`">
                <i class="opacity-10" :class="typeof icon === 'string' ? icon : icon.component" aria-hidden="true"></i>
            </div>
        </div>
