                   ...
                   { title: listTitle, order, values, info, image, icon }, index
                     ...
                     <td>
                        <div class="px-3 py-1 d-flex">
                           <ArgonAvatar :image="image" class="me-3" border-radius="lg" alt="avatar image" />
                     ...
                     <td class="align-middle text-center">
                        <div class="text-center px-3 py-1 d-flex justify-content-center align-items-center">
                           ...
                           <ArgonButton v-if="info" size="sm" color="secondary" variant="outline"
                              class="btn-icon-only btn-rounded mb-0 ms-2 btn-sm d-flex align-items-center justify-content-center ms-3"
                              data-bs-toggle="tooltip" data-bs-placement="bottom" :data-bs-original-title="info">
