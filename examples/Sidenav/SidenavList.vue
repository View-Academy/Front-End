                ...
                <sidenav-collapse collapse-ref="applicationsExamples" nav-text="Admin"
                    ...
                    <template #list>
                        <ul class="nav ms-4">
                            ...
                            <SidenavItem to="/admin/users" mini-icon="U" text="User List" />
                            <SidenavItem to="/admin/quizesList" mini-icon="Q" text="Quizes List" />
                        </ul>
                    </template>
                </sidenav-collapse>
                    ...
                    <template #list>
                        <ul class="nav ms-4">
                            <SidenavCollapseItem refer="profileExample" mini-icon="P" text="Profile">
                                <template #nav-child-item>
                                    <SidenavItem to="/pages/profile/profile-overview" mini-icon="P"
...
const haloo = computed(() => store.getters.isAuthenticated);
