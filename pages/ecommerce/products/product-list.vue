                  ...
                  <div class="d-lg-flex">
                     ...
                     <div class="my-auto mt-4 ms-auto mt-lg-0">
                        <div class="my-auto ms-auto">
                           <a href="./new-product" class="mb-0 btn bg-gradient-success btn-sm" target="_blank">+&nbsp; New
                              Product</a>
                                 ...
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                       ...
                                       <div class="form-check">
                                          <input id="importCheck" class="form-check-input" type="checkbox" value=""
                                             checked="" />
                           ...
                           <button class="mt-1 mb-0 btn btn-outline-success btn-sm export mt-sm-0" data-type="csv"
