<template>
   <div class="container-fluid py-4">
         ...
         <div class="col-12">
            <div class="card">
               ...
               <div class="card-body p-3">
                  <div class="row">
                     <OutlinedCounterCard :duration="2500" prefix="$" :count="23980" title="Earning" />
                     <OutlinedCounterCard prefix="$" :count="2400" title="Customers" />
                     <OutlinedCounterCard class="mt-4 mt-lg-0" prefix="$" :count="48" title="Avg. Value" />
                     <OutlinedCounterCard :duration="3000" class="mt-4 mt-lg-0" suffix="%" :count="4"
                        title="Refund Rate" />
                  </div>
                  <div class="row mt-5">
                           ...
                           <div class="d-flex align-items-center">
                              <div class="form-group w-70">
                                 <div class="input-group bg-gray-200">
                                    <input class="form-control form-control-sm" value="soft-ui-dashboard-vmsk392"
                                       type="text" disabled onfocus="focused(this)" onfocusout="defocused(this)" />
                     ...
                     <div class="col-lg-7 col-12 mt-4 mt-lg-0">
                        ...
                        <div class="row">
                           <TransparentInfoCard :icon="{ component: 'ni ni-money-coins', color: 'dark' }"
                              description="1. Create & validate your referral link and get"
                              value="<span class='small'>$</span>100" />
                           <TransparentInfoCard :icon="{ component: 'ni ni-send', color: 'dark' }"
                              description="2. For every order you make you get" value="10 <span class='small'>%</span>" />
                           <TransparentInfoCard :icon="{ component: 'ni ni-spaceship', color: 'dark' }"
                  ...
                  <div class="row mt-4">
                     ...
                     <ComplexBackgroundCard class="mt-4 mt-lg-0"
                        ...
                        description="Send the invitation link to 10 friends and get a 50%
                             coupon to use on any purchase." :action="{ route: 'javascript:;', label: 'Read more' }" />
                           ...
                           <div class="card-body position-relative z-index-1 d-flex flex-column">
                              <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                 <img class="w-50 position-relative z-index-2"
                                    src="../../assets/img/illustrations/icon-documentation.svg" alt="illustration" />
                              </div>
      ...
      <div class="col-12 mt-4">
         <OrdersListCard title="Top Referred Users" :headers="['User', 'Value', 'Profit', 'Refunds']" :lists="users" />
      </div>
   </div>
</template>
