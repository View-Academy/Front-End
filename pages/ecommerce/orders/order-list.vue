                  ...
                  <table id="order-list" class="table table-flush">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td class="text-xs font-weight-bold">
                              <div class="d-flex align-items-center">
                                 <ArgonAvatar :image="img1" class="me-2" size="xs" circular alt="user image" />
                        ...
                        <tr>
                           ...
                           <td class="text-xs font-weight-bold">
                              <div class="d-flex align-items-center">
                                 <ArgonAvatar :image="img2" size="xs" circular class="me-2" alt="user image" />
                        ...
                        <tr>
                           ...
                           <td class="text-xs font-weight-bold">
                              <div class="d-flex align-items-center">
                                 <ArgonButton color="dark" variant="outline"
                                    class="btn-icon-only btn-rounded mb-0 me-2 btn-sm d-flex align-items-center justify-content-center">
                        ...
                        <tr>
                           ...
                           <td class="text-xs font-weight-bold">
                              <div class="d-flex align-items-center">
                                 <div class="d-flex align-items-center">
                                    <ArgonAvatar :image="img3" size="xs" class="me-2" circular alt="user image" />
                        ...
                        <tr>
                           ...
                           <td class="text-xs font-weight-bold">
                              <div class="d-flex align-items-center">
                                 <div class="d-flex align-items-center">
                                    <ArgonAvatar :image="img4" size="xs" circular class="me-2" alt="user image" />
                        ...
                        <tr>
                           ...
                           <td class="text-xs font-weight-bold">
                              <div class="d-flex align-items-center">
                                 <div class="d-flex align-items-center">
                                    <ArgonAvatar :image="img5" size="xs" circular class="me-2" alt="user image" />
                        ...
                        <tr>
                           ...
                           <td class="text-xs font-weight-bold">
                              <div class="d-flex align-items-center">
                                 <div class="d-flex align-items-center">
                                    <ArgonAvatar :image="img6" size="xs" class="me-2" alt="user image" circular />
