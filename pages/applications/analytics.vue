   ...
   <div class="py-4 container-fluid">
      <div class="row">
         <div class="col-lg-6 col-12 d-flex ms-auto">
            ...
            <div class="dropleft ms-3">
               <button id="dropdownImport" class="btn bg-gradient-dark dropdown-toggle" type="button"
      ...
      <div class="row">
         <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
            <MiniStatisticsCard title="Users" value="930" :percentage="{ value: '+55%', color: 'success' }" :icon="{
               component: 'ni ni-circle-08',
               background: 'bg-gradient-dark',
            }" />
         </div>
         <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
            <MiniStatisticsCard title="New Users" value="744" :percentage="{ value: '+3%', color: 'success' }" :icon="{
               component: 'ni ni-world',
               background: 'bg-gradient-dark',
            }" />
         </div>
         <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
            <MiniStatisticsCard title="Sessions" value="1,414" :percentage="{ value: '-2%', color: 'danger' }" :icon="{
               component: 'ni ni-watch-time',
               background: 'bg-gradient-dark',
            }" />
         </div>
         <div class="col-xl-3 col-sm-6">
            <MiniStatisticsCard title="Pages/Session" value="1.76" :percentage="{ value: '+5%', color: 'success' }" :icon="{
      ...
      <div class="row">
         <div class="col-lg-7 col-md-12">
            <div class="card">
               ...
               <DefaultLineChart title="" class="shadow-none" :chart-options="{
                  chart: {
                     height: 300,
                     type: 'line',
                     zoom: {
   ...
   },
   {
      ...
      data: [40, 80, 70, 90, 30, 90, 140, 130, 200],
         ...
         <div class="mt-4 col-lg-5 col-md-12 mt-lg-0">
            <DefaultDoughnutChart title="Refferals" :chart-options="{
               chart: {
                  type: 'donut',
               },
      ...
      <div class="mt-4 row">
         ...
         <div class="col-sm-6">
            <AnalyticsCard title="Pages" :headers="['Page', 'Page Views', 'Avg. Time', 'Bounce Rate']" :pages="[
               {
                  url: '/bits',
                  views: 345,
                  time: '00:17:07',
