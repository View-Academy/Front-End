<template>
               ...
               <div class="mx-auto text-center col-lg-4 col-md-6 col-7">
                  <div class="mt-5 nav-wrapper position-relative z-index-2">
                     <ul id="tabs-pricing" class="flex-row p-1 nav nav-pills nav-fill" role="tablist">
                        ...
                        <li class="nav-item">
                           <a id="tabs-iconpricing-tab-2" class="mb-0 nav-link" data-bs-toggle="tab" href="#annual"
                              role="tab" aria-controls="annual" aria-selected="false">Annual</a>
                        </li>
                     </ul>
                  </div>
               </div>
               ...
               <div id="monthly" class="tab-pane active">
                  <div class="row">
                     <div class="mb-4 col-lg-4 mb-lg-0">
                        <PricingCard badge="Starter" :price="{ currency: '$', value: '59' }" :specifications="[
   ...
   label: 'Join',
                     ...
                     <div class="mb-4 col-lg-4 mb-lg-0">
                        <PricingCard badge="premium" :price="{ currency: '$', value: '89' }" :specifications="[
   ...
   label: 'Try Premium',
                     ...
                     <div class="mb-4 col-lg-4 mb-lg-0">
                        <PricingCard badge="Enterprise" :price="{ currency: '$', value: '99' }" :specifications="[
   ...
   label: 'Join',
               ...
               <div id="annual" class="tab-pane">
                  <div class="row">
                     <div class="mb-4 col-lg-4 mb-lg-0">
                        <PricingCard badge="Starter" :price="{ currency: '$', value: '119' }" :specifications="[
                           { label: '2 team members', includes: true },
                           { label: '20GB Cloud storage', includes: true },
                           { label: 'Integration help', includes: false },
                           { label: 'Sketch Files', includes: false },
   ...
   label: 'Join',
                     ...
                     <div class="mb-4 col-lg-4 mb-lg-0">
                        <PricingCard badge="premium" :price="{ currency: '$', value: '159' }" :specifications="[
                           { label: '10 team members', includes: true },
                           { label: '40GB Cloud storage', includes: true },
                           { label: 'Integration help', includes: true },
                           { label: 'Sketch Files', includes: true },
   ...
   label: 'Try Premium',
                     ...
                     <div class="mb-4 col-lg-4 mb-lg-0">
                        <PricingCard badge="Enterprise" :price="{ currency: '$', value: '399' }" :specifications="[
                           { label: 'Unlimited team members', includes: true },
                           { label: '100GB Cloud storage', includes: true },
                           { label: 'Integration help', includes: true },
                           { label: 'Sketch Files', includes: true },
