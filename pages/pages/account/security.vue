<template>
    <div class="container-fluid mt-6">
        ...
        <div class="row mt-4">
            <div class="col-sm-6">
                <select id="choices-questions" class="form-control" name="choices-questions">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        <div class="form-group d-flex align-items-center justify-content-between">
                            ...
                            <ArgonSwitch id="notify-via-email" name="Email" checked class="ms-3" />
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between">
                        ...
                        <div class="form-group d-flex align-items-center justify-content-between">
                            ...
                            <ArgonSwitch id="check-devices" name="Devices" checked class="ms-3" />
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between">
                            <span class="text-sm">
                        ...
                        <div class="row mt-5">
                            <div class="col-lg-8 col-12 actions text-end ms-auto">
                                <ArgonButton color="success" variant="outline" size="sm" class="btn-sm mb-0 me-1"
                                    type="reset">Cancel</ArgonButton>
                                <ArgonButton color="success" variant="gradient" size="sm" class="btn-sm mb-0" type="button">
                ...
                <div class="card">
                    <div class="card-header p-3 pb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <ArgonButton color="dark" variant="gradient" size="sm" class="ms-auto mb-0">Enable</ArgonButton>
                        </div>
                    </div>
                    <div class="card-body p-3">
                        ...
                        <div class="card">
                            <div class="card-body border-radius-lg bg-gradient-dark p-3">
                                ...
                                <ArgonButton color="light" variant="gradient" class="mb-0">Contact Us</ArgonButton>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 pb-3">
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        ...
                        <ArgonInput id="current-password" type="password" placeholder="Current Password" />
                        ...
                        <ArgonButton color="dark" variant="gradient" full-width class="w-100 mb-0">Update password
                        </ArgonButton>
                    </div>
                </div>
            </div>
